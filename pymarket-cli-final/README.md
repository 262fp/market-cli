...
Producto final del curso de Fundamentos de Programacion.

Esta version consolida U1 y U2 e incorpora procesamiento algoritmico avanzado con diccionarios, matrices, reportes y exportacion simple a archivos.
...
- Diccionarios para indices y agregaciones por categoria.
- Matrices para resumen tabular de categorias.
